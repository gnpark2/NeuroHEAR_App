...
import 'advanced_practice_page_model.dart';
export 'advanced_practice_page_model.dart';

import 'package:audioplayers/audioplayers.dart';

class AdvancedPracticePageWidget extends StatefulWidget {
  const AdvancedPracticePageWidget({super.key});

  @override
  State<AdvancedPracticePageWidget> createState() =>
      _AdvancedPracticePageWidgetState();
}

class _AdvancedPracticePageWidgetState extends State<AdvancedPracticePageWidget> {
  late AdvancedPracticePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdvancedPracticePageModel());
  }
  ...
  Future<AudioPlayer> playNoise() async {
    final noisePlayer = AudioPlayer();
    _audioPlayers.add(noisePlayer);
    await noisePlayer.play(AssetSource('audios/noise/44100_noise_0dBFS.wav'));
    return noisePlayer;
  }
  ...
  Future<void> playRandomAudios(int count) async {
    ...
    final noisePlayer = await playNoise();
    ...
    await noisePlayer.stop(); // Stop noise after playing audios
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<AdvancedResultsRecord>>(
      stream: queryAdvancedResultsRecord(
        ...
        queryBuilder: (advancedResultsRecord) => advancedResultsRecord
      ...
      builder: (context, snapshot) {
        ...
        List<AdvancedResultsRecord> testAdvancedResultsRecordList = snapshot.data!;
        AdvancedResultsRecord? testAdvancedResultsRecord;

        // If no record exists for today, create one
        if (testAdvancedResultsRecordList.isEmpty) {
          AdvancedResultsRecord.createDoc(currentUserReference!).set(
            createAdvancedResultsRecordData(
              numOfQuestions: 0,
          ...
          testAdvancedResultsRecord = testAdvancedResultsRecordList.first;
        }
                      ...
                      children: [
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  ClipRRect(
                                    borderRadius: BorderRadius.circular(8.0),
                                    child: Image.asset(
                                      'assets/images/Screenshot_2024-06-29_at_10.42.23_PM-removebg-preview.png',
                                  ...
                                  Text(
                                    '3. 소음 없이 불려진 숫자 하나가 앞에서 들은 숫자들 사이에 있었나요? 없었나요?\n기억을 더듬어서 답을 눌러주세요!',
                                    textAlign: TextAlign.center,
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                        '본 훈련은 숫자 세 개가 소음과 함께 스피커로 불려지고, 그 후에 무작위로 숫자 하나가 제시 됩니다.',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Readex Pro',
                                      ...
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0.0, 16.0, 0.0, 0.0),
                                        child: Text(
                                          '소음 속에서 불리는 세 가지의 숫자에 집중해주세요. 만약 아무리 노력해도 안 들리신다면 기본 훈련으로 학습해주세요.',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily: 'Readex Pro',
                        ...
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 8.0, 0.0, 8.0),
                          child: Text(
                            '소음이 큰 편이니 볼륨을 극히 낮춘 상태로 시작하시고, 이숙해지시면 음량을 조절해주시기 바랍니다.',
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  fontFamily: 'Readex Pro',
                                  color: Color(0xFFE23103),
                                  fontSize: 24.0,
                                  letterSpacing: 0.0,
                                  lineHeight: 1.6,
                                ),
                                  ...
                                  children: [
                                    FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        if (testAdvancedResultsRecord != null && resultMessage == '정답입니다!') {
                                          await testAdvancedResultsRecord.reference.update({
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                        '본 훈련은 숫자 네 개가 소음과 함께 스피커로 불려지고, 그 후에 무작위로 숫자 하나가 제시 됩니다.',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Readex Pro',
                                      ...
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0.0, 16.0, 0.0, 0.0),
                                        child: Text(
                                          '소음 속에서 불리는 네 가지의 숫자에 집중해주세요. 만약 아무리 노력해도 안 들리신다면 기본 훈련으로 학습해주세요.',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily: 'Readex Pro',
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                        '본 훈련은 숫자 다섯 개가 소음과 함께 스피커로 불려지고, 그 후에 무작위로 숫자 하나가 제시 됩니다.',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Readex Pro',
                                      ...
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0.0, 16.0, 0.0, 0.0),
                                        child: Text(
                                          '소음 속에서 불리는 다섯 가지의 숫자에 집중해주세요. 만약 아무리 노력해도 안 들리신다면 기본 훈련으로 학습해주세요.',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily: 'Readex Pro',
...
// Ensure that createAdvancedResultsRecordData includes createdTime
